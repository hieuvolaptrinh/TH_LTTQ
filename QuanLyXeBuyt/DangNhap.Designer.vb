...
Partial Class DangNhap
    ...
    Private Sub InitializeComponent()
        ...
        Guna2TextBox2.BorderColor = Color.IndianRed
        ...
        Guna2ImageButton1.Location = New Point(784, 156)
        ...
        Label1.Name = "Label1"
        Label1.Size = New Size(311, 68)
        Label1.TabIndex = 0
        Label1.Text = "HỆ THỐNG QUẢN LÝ" & vbCrLf & " XE KHÁCH"
        ...
        Label4.Font = New Font("Segoe UI", 13.8F, FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        Label4.ForeColor = SystemColors.Control
        Label4.Location = New Point(40, 145)
        Label4.Name = "Label4"
        Label4.Size = New Size(301, 155)
        Label4.TabIndex = 2
        Label4.Text = "Chào mừng bạn đến với" & vbCrLf & "hệ thống quản lý xe khách. " & vbCrLf & "Hệ thống hỗ trợ tìm kiếm, " & vbCrLf & "đặt vé an toàn, nhanh chóng " & vbCrLf & "và chính xác."
        ' 
        ' Guna2GradientPanel1
        ' 
